                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href=""><i class="fa fa-list" aria-hidden="true"></i>Quản lý
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h2 class="modal-title" id="addModalLabel"> Thông tin giáo viên</h3>
                                            ...
                                            if(isset($_POST['them']))
                                            {
                                                ...
                                                if($tengv == "")
                                                {
                                                    echo"<script>alert('Vui lòng nhập tên giáo viên') </script>";
                                                ...
                                                {
                                                    echo"<script>alert('Vui lòng nhập chuyên môn') </script>";

                                                }
                                              
                                                else 
                                                {
                                                    $sql = "INSERT INTO giaovien(TenGV,DiaChi,SDT,Email,ChuyenMon)
                                                    VALUES('$tengv','$diachi','$sdt','$Email','$chuyenmon')";
                                            ...
                                            <form  action="TTGiaoVien.php" method="post">
                                                    <div class="form-group">
                                                        <label class="col-form-label font-weight-bold">Mã giáo viên<span class="text-danger">
                                                         (*)</span></label>
                                                        <input type="text" name="magv" readonly class="form-control">
                                                    </div>
                            ...
                            <div class="row table-responsive mx-auto" style="font-size: 14px">
                                <table class="table table-striped">
                                 ...
                                 if(isset( $_GET["tukhoa"]))
                                        {
                                            $tukhoa=$_GET["tukhoa"];
                                            $sql = "SELECT * FROM giaovien where  giaovien.TenGV like  N'%$tukhoa%'"; 
                                      ...
                                      echo "
                                                ...
                                                <tr>
                                                    ...
                                                    <span data-toggle=\"modal\" data-target=\"#editModal\">
                                                            <a href=\"SuaGV.php?magv=".$row['MaGV']."\" class=\"text-success\" data-toggle=\"tooltip\"
                                                        ...
                                                        <span>
                                                            <a href=\"javascript:xacnhanxoa('XoaGV.php?MaGV=".$row['MaGV']."')\" class=\"text-danger ml-3\" title=\"Xóa\"><i
                                ...
                                <div class="modal fade" id="editModal" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h2 class="modal-title" id="editModalLabel">Sửa TT giáo viên
                                                                    </h3>
                                ...
                                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h2 class="modal-title" id="deleteModalLabel">Xóa giáo viên
                                                                    </h3>
                                                                    <button type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
