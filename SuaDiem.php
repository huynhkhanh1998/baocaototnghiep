            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                        ...
                        <div class="card-header">
                            <div class="row float-left" style="font-size: 20px;">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Cập nhật thông tin điểm</li>
                                    </ol>
                                </nav>
                            </div>
                            <?php
                            ...
                            $id=$_GET['MaHV'];
                            $ml=$_GET['MaLop'];
                            $sql = "select * from kqua where MaHV=$id and MaLop=$ml"; 
                            ...
                            $sql = "update kqua set MaHV=\"$mahv\",MaLop=\"$malop\",DiemSo=\"$diemso\",TrangThai=\"$trangthai\" where MaHV=$mahv and MaLop=$malop ";  
                            
                   
                            if(mysqli_query($conn, $sql))
                    { 
                        echo"<script>alert('Cập nhật thành công') </script>";
                        echo"<script>window.location='QLDiem.php?tk=Tìm+kiếm&malop=$malop'</script>";
                            ...
                            ?>
                                         ...
                                         <div class="form-group" style="width: 30%">
                                                    ...
                                                    <div class="form-group" style="width: 30%">
                                                        ...
                                                        <input type="text" name ="diemso"  value ="<?=$diemso ?>" class="form-control">
                                                    </div>
                                                    ...
                                                    <a class="btn btn-danger" href="QLDiem.php">Đóng</a>
