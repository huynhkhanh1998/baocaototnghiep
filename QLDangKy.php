                            ...
                            <div class="row float-left" style="font-size: 20px;">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Thông tin đăng ký</li>
                                    </ol>
                                </nav>
                            </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h2 class="modal-title" id="addModalLabel">Thêm Thông tin đăng ký</h3>
                                            ...
                                            if(isset($_POST['them']))
                                            {
                                                ...
                                                $ngaydk=$_POST['ngaydk'];
                                                $str=explode("-",$_POST['ngaydk']);
                                                $ngaydk=$str[2]."-".$str[1]."-".$str[0]."-";
                                                ...
                                                if($ngaydk == "")
                                                {
                                                    echo"<script>alert('Vui lòng nhập ngày đăng ký') </script>";

                                                }
                                                else 
                                                {
                                                    $sql = "INSERT INTO ketqua(MaHV,MaLop,NgayDangKy,TrangThai,HTDK)
                                                    VALUES('$mahv','$malop','$ngaydk','$trangthai','$htdk')";
                                                    $sql1 = "INSERT INTO kqua(MaHV,MaLop)
                                                    VALUES('$mahv','$malop')";
                                                ...
                                                { 
                                                   ...
                                                   echo"<script>alert('Thêm thành công') </script>";
                                                    echo"<script>window.location='QLDangKy.php'</script>";
                                                    }
                                   ...
                                   <label class="col-form-label font-weight-bold">Mã lớp</label>
                                                        ...
                                                        <?php
                                                         ...
                                                         while($l = mysqli_fetch_array($ra)){
                                                               ...
                                                               echo " <option value=\"".$l['MaLop']."\">".$l['MaLop']." - ".$l['TenLop']."</option>  ";
                                                         }
                                                        }
                                                                ?> 
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input type="text" name ="ngaydk" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-form-label font-weight-bold">Trạng thái</label>
                                                        <select class="form-control" name="trangthai">
                                                                <option>Đã đóng học phí</option>
                                                                <option>Chưa đóng học phí</option> 
                        ...
                        <div class="card-body">
                            <div class="row table-responsive mx-auto" style="font-size: 14px">
                                <table class="table table-striped">
                                    ...
                                    {
                                        $tukhoa=$_GET["tukhoa"];
                                        $sql = "SELECT ketqua.*,TenHV,TenLop FROM ketqua,hocvien,lop where ketqua.MaHV = hocvien.MaHV and ketqua.MaLop = lop.MaLop and hocvien.TenHV  like  N'%$tukhoa%'"; 

                                    }
                                    else
                                    {
                                        $sql = "SELECT ketqua.*,TenHV,TenLop FROM ketqua,hocvien,lop where ketqua.MaHV = hocvien.MaHV and ketqua.MaLop = lop.MaLop "; 
                                      ...
                                      echo "
                                                ...
                                                <tr>
                                                    ...
                                                    <span data-toggle=\"modal\" data-target=\"#editModal\">
                                                            <a href=\"SuaDK.php?MaHV=".$row['MaHV']."&MaLop=".$row['MaLop']."\" class=\"text-success\" data-toggle=\"tooltip\"
                                                        ...
                                                        <span>
                                                            <a href=\"javascript:xacnhanxoa('XoaDK.php?MaHV=".$row['MaHV']."&MaLop=".$row['MaLop']."')\" class=\"text-danger ml-3\" title=\"Xóa\"><i
                                ...
                                <div class="modal fade" id="editModal" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h2 class="modal-title" id="editModalLabel">Sửa TT đăng ký
                                                                    </h3>
                                                            ...
                                                            <form>
                                                    <div class="form-group">
                                                        <label class="col-form-label font-weight-bold">Tên học viên<span class="text-danger">
                                                         (*)</span></label>
                                ...
                                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h2 class="modal-title" id="deleteModalLabel">Xóa đăng ký
                                                                    </h3>
                                                                    <button type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
