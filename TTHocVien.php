                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h2 class="modal-title" id="addModalLabel">Thông tin học viên</h3>
                                            ...
                                            if(isset($_POST['them']))
                                            {
                                                ...
                                                {
                                                    echo"<script>alert('Vui lòng nhập nơi sinh') </script>";
                                                ...
                                                {
                                                    $sql = "INSERT INTO hocvien(TenHV, NgaySinh,NoiSinh,DiaChi,SDT,Email,MaCQ)
                                                    VALUES('$tenhv','$ngaysinh','$noisinh','$diachi','$sdt','$Email','$macq')";
                                            ...
                                            <div class="modal-body">
                                                <form  action="TTHocVien.php" method="post">
                                                    <div class="form-group">
                                                        <label class="col-form-label font-weight-bold">Mã học viên<span class="text-danger">
                                                         (*)</span></label>
                                                        <input type="text" name ="mahv" readonly  class="form-control">
                                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row table-responsive mx-auto" style="font-size: 14px">
                                <table class="table table-striped">
                                    ...
                                    {
                                        $tukhoa=$_GET["tukhoa"];
                                        $sql = "SELECT hocvien.*,TenCQ FROM hocvien,coquan where hocvien.MaCQ = coquan.MaCQ and hocvien.TenHV like  N'%$tukhoa%'"; 

                                    }
                                    else
                                    {
                                        $sql = "SELECT hocvien.*,TenCQ FROM hocvien,coquan where hocvien.MaCQ = coquan.MaCQ "; 
                             ...
                             while($row = mysqli_fetch_array($retval)){  
                              echo "
                                        ...
                                        <tr>
                                            ...
                                            <a href=\"SuaHV.php?MaHV=".$row['MaHV']."&MaCQ=".$row['MaCQ']."\" class=\"text-success\" data-toggle=\"tooltip\"
                                        ...
                                        <span>
                                        <a href=\"javascript:xacnhanxoa('XoaHV.php?MaHV=".$row['MaHV']."&MaCQ=".$row['MaCQ']."')\" class=\"text-danger ml-3\" title=\"Xóa\"><i
                                ...
                                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h2 class="modal-title" id="deleteModalLabel">Xóa học viên
                                                                    </h3>
                                ...
                                <div class="modal fade" id="editModal" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h2 class="modal-title" id="editModalLabel">Sửa TT học viên
                                                                    </h3>
                                                                    <button type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        <label class="col-form-label font-weight-bold">Tên cơ quan</label>
                                                        <select class="form-control">
                                                                <option></option>                                      
                                                        </select>
                                                    </div>
...
function  ktra()
{
    var txtsearch = document.getElementByID('tukhoa').value;
    if( txtsearch == "" ){
    
        alert('Vui lòng nhập từ khóa cần tìm');
    }
        else
        window.location="TimKiemHV.php?key="+txtsearch;
