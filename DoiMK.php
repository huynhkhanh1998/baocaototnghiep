                ...
                <div class="card">
                    ...
                    <div class="card-body mx-auto">
                        <?php
                         ...
                         {
                            $matkhaucu = addslashes($_POST['matkhaucu']);
                            $matkhaumoi = addslashes($_POST['matkhaumoi']);
                            $xacnhanmatkhaumoi = addslashes($_POST['xacnhanmatkhaumoi']);
                            $tendn=$_SESSION['hv'];
                            $query = mysqli_query($conn,"SELECT  MatKhau  FROM taikhoan WHERE TenDangNhap='$tendn'");
                            ...
                            if ($matkhaucu != $row['MatKhau']) {
                                ...
                                if($matkhaumoi== "")
                                {
                                    echo"<script>alert('Bạn cần nhập mật khẩu mới') </script>";

                                }
                                else  if($xacnhanmatkhaumoi== "")
                                echo"<script>alert('Bạn cần nhập mật khẩu để xác nhận') </script>";
                                else if($matkhaumoi==$xacnhanmatkhaumoi)
                                {
                                    $sql = "update taikhoan set MatKhau=\"$matkhaumoi\" where TenDangNhap='$tendn'";  
                        ...
                        <!-- Hiển thị thông báo lỗi? -->
                            ...
                            <button type="submit" name="xacnhan" class="btn btn-primary  float-right">Xác nhận</button>
                        </form>
                    </div>
                </div>
            </div>
