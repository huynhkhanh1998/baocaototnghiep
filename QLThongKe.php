                            ...
                            <div class="row float-left" style="font-size: 20px;">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Danh sách học viên được cấp giấy chứng nhận</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="row float-right bg-success mr-3 mt-2">
                            
            <form action="QLThongKe.php" method="get">
...
aria-labelledby="addModalLabel" aria-hidden="true">
                                ...
                                <table class="table table-striped">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th input  scope="col">Họ và tên</th>
                                     ...
                                     if (isset($_REQUEST['tk'])) 
        {
            ...
            {    
                $sql = "select kqua.*,TenLop,hocvien.*,TenCQ from coquan,kqua,lop,hocvien where hocvien.MaCQ=coquan.MaCQ and kqua.MaLop=lop.Malop and kqua.MaHV =hocvien.MaHV and DiemSo >= 5  and lop.MaLop like '%$malop%'";
                include"ketnoi_csdl.php";
                ...
                $i=1;
                {
                    ...
                    while ($row = mysqli_fetch_assoc($retval)) { 
                        ...
                        ?>
                                         ...
                                         <form action="docfile.php"  method="POST" > <input class="btn btn-success"  type="submit" name="btnExport" value="In danh sách" /> </form>
