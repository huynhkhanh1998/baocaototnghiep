            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                        ...
                        <div class="card-header">
                            <div class="row float-left" style="font-size: 20px;">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Cập nhật thông tin đăng ký</li>
                                    </ol>
                                </nav>
                            </div>
                            <?php
                            ...
                            $id=$_GET['MaHV'];
                            $ml=$_GET['MaLop'];
                            $sql = "select * from ketqua where MaHV=$id and MaLop=$ml"; 
                            ...
                            $ndk=date("d-m-Y",strtotime($row['NgayDangKy']));
                            ...
                            $sql = "update ketqua set MaHV=\"$mahv\",MaLop=\"$malop\",NgayDangKy=\"$ngaydk\",TrangThai=\"$trangthai\" where MaHV=$mahv and MaLop=$malop ";  
                                         ...
                                         <div class="form-group" style="width: 30%">
                                                        <label class="col-form-label font-weight-bold">Mã học viên<span class="text-danger">
                                                         ...
                                                         while($r = mysqli_fetch_array($re)){
                                                               ...
                                                               echo " <option ";
                                                               if($r['MaHV']==$id) echo "selected=''";
                                                               echo" value=\"".$r['MaHV']."\">".$r['MaHV']." - ".$r['TenHV']."</option>  ";
                                                         }
                                                        }
                                                                ?>                                    
                                                        </select>
                                                    ...
                                                    <div class="form-group" style="width: 30%">
                                                        ...
                                                        <select class="form-control" readonly  name="malop">
                                                        <?php
                                                          if(isset($_GET['MaLop'])){
                                                            $id=$_GET['MaLop'];
                                                          }
                                                    ...
                                                    <div class="form-group" style="width: 30%">
                                                        ...
                                                        <input type="text" name ="ngaydk"  value ="<?=$ndk ?>" class="form-control">
                                                    </div>
                                                    ...
                                                    <a class="btn btn-danger" href="QLDangKy.php">Đóng</a>
