    ...
    <div class="jumbotron mt-6">
        ...
        <?php
                                            ...
                                            if(isset($_POST['dang']))
                                            {
                                                ...
                                                if($tenhv == "")
                                                {
                                                    echo"<script>alert('Vui lòng nhập tên học viên') </script>";

                                                }
                                               
                                                else 
                                                {
                                                    $sql = "INSERT INTO hocvien(TenHV, NgaySinh,DiaChi,SDT,MaCQ)
                                                    VALUES('$tenhv','$ngaysinh','$diachi','$sdt','$macq')";

                                                    $sql1 = "INSERT INTO ketqua(MaHV,MaLop,NgayDangKy,HTDK)
                                                    VALUES((select max(MaHV) from hocvien),'$malop','$ngaydk',N'Đăng ký Online')";

                                                    $sql2 = "INSERT INTO kqua(MaHV,MaLop)
                                                    VALUES((select max(MaHV) from hocvien),'$malop')";
                            ...
                            <form  action="dangky.php" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label style="font-size: 21px">Họ và tên</label>
                                        <input type="text" name ="tenhv" class="form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label style="font-size: 21px" >Tên lớp</label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label style="font-size: 21px" >Tên cơ quan<span class="text-danger"> (*)</span></label>
                                        <select class="form-control" name="macq">
                                                        <?php
                                                         ...
                                                         while($r = mysqli_fetch_array($re)){
                                                               ...
                                                               echo " <option value=\"".$r['MaCQ']."\">".$r['MaCQ']." - ".$r['TenCQ']."</option>  ";
                                                         }
                                                        }
                                                                ?>                                          
                                                        </select>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label style="font-size: 21px" >Số điện thoại<span class="text-danger"> (*)</span></label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label style="font-size: 21px">Ngày sinh<span class="text-danger"> (*)</span></label>
                                        <input type="text" name ="ngaysinh" class="form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label style="font-size: 21px" >Địa chỉ<span class="text-danger"> (*)</span></label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label  style="font-size: 21px">Ngày đăng ký<span class="text-danger"> (*)</span></label>
                                ...
                                <button style="font-size: 21px" type="submit" name="dang" class="btn btn-primary">Xác nhận</button>
                                </form>
